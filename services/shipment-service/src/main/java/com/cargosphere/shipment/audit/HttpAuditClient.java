...
public class HttpAuditClient
    ...
    public void publish(
        ...
        if (properties.getApiKey() == null
            ...
            log.warn(
                    "Shipment audit event skipped because the internal audit API key is not configured"
            );
        ...
        try {
            ...
            /*
             * Audit-service failure must not break
             * shipment creation or status updates.
             */
            log.warn(
                    "Shipment audit delivery failed: action={}, entityId={}, cause={}",
                    request.action(),
                    request.entityId(),
                    exception
                            .getClass()
