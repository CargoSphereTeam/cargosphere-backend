...
@Table(
        ...
        indexes = {
                @Index(name = "idx_shipments_client_user_id", columnList = "client_user_id"),
                @Index(name = "idx_shipments_status", columnList = "status"),
                @Index(name = "idx_shipments_shipment_number", columnList = "shipment_number")
        }
)
public class Shipment {
    ...
    @Column(name = "origin_location", nullable = false, length = 150)
